...
create_tibble <- function(path="./political_interest/data/wvs/resp_prompt1/"){
        resp <- tibble()
...
tictoc::tic()
resp <- create_tibble("./political_interest/data/wvs/resp_prompt1/")
tictoc::toc()
...
variability_metrics %>% 
        ...
        knitr::kable(digits=2) %>%
        writeLines('./political_interest/paper/tables/modal_statistcs.md')
...
ggsave(
        "./political_interest/paper/plots/mae_by_model_country.png",
        width = 8,
        height = 5,
        units = "in",
        dpi = 300
...
resp %>% 
        ...
        writeLines("./political_interest/paper/tables/models_table.md")
...
ggsave(
        "./political_interest/paper/plots/regresion_model_country.png",
        width = 12,
        height = 10,
        units = "in",
        dpi = 300
...
df <- read_rds('./political_interest/data/wvs/WVS_Cross-National_Wave_7_rds_v6_0.rds')
